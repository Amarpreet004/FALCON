...
export default function GraphicsHero() {
	return (
		<section className="w-full bg-white py-12 px-4 flex flex-col md:flex-row items-center justify-center min-h-[60vh] relative overflow-hidden">
			{/* Left: Image & Shapes */}
			<div className="relative flex-1 flex items-center justify-center mb-10 md:mb-0">
				...
				<img
					...
					alt="UI/UX Designer"
					className="relative z-10 w-64 h-64 object-cover object-top rounded-2xl shadow-xl border-4 border-white"
					draggable={false}
				/>
				{/* Decorative shapes */}
			...
			{/* Right: Content */}
			<div className="flex-1 flex flex-col items-start md:pl-12 animate-fade-in-right">
				<span className="text-lg font-semibold text-[#660033] mb-2 animate-slide-in">Hello, I'm Nancy</span>
				<h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-[#222] mb-4 leading-tight animate-fade-in">
					Professional <span className="text-[#660033]">UI/UX Designer</span><br />& Web Developer
				</h1>
				...
				<div className="flex items-center gap-4 mt-2 mb-4">
					<a href="#" className="w-10 h-10 flex items-center justify-center rounded-full border-2 border-[#660033] text-[#660033] hover:bg-[#660033] hover:text-white transition-all duration-300">
				...
				<div className="absolute right-0 bottom-8 flex flex-col items-center">
					<span className="text-xs text-[#660033] font-medium rotate-90 tracking-widest">Social Down</span>
