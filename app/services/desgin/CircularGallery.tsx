...
class Media {
  ...
  onResize({ screen, viewport }: { screen?: ScreenSize; viewport?: Viewport } = {}) {
    ...
    this.plane.scale.x = (this.viewport.width * (1000 * this.scale)) / this.screen.width; // Increased from 700 to 1000
    this.plane.program.uniforms.uPlaneSizes.value = [this.plane.scale.x, this.plane.scale.y];
    this.padding = 3; // Increased padding from 1 to 3 for more gap between cards
...
class App {
  ...
  createMedias(
    ...
    const defaultItems = [
      {
        image: `/uniquesimage.png`,
        text: "The Uniques Community",
      
      },
      {
        image: `/techleran.png`,
        text: "Teach Learn Academy",
      },
      {
        image: `/bharattech.png`,
        text: "Bharat Tech  Hackathon",
      },
      {
        image: `/Global.png`,
        text: "Global Future Summit",
      },
       {
        image: `/amartrevel.png`,
        text: "Amar Trevel",
      },
  ...
  onClick(e: MouseEvent) {
    ...
    if (this.onImageClick && !this.isDown) {
      this.onImageClick();
    }
  }
