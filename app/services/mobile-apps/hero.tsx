	...
	return (
		<section className="relative w-full flex flex-col md:flex-row items-center justify-between bg-[#F7F6FA] pt-12 pb-8 px-4 md:px-16 overflow-hidden">
			...
			<div className="flex-1 flex flex-col justify-center z-10 max-w-xl">
				...
				<div className="mt-10 bg-[#E7E4F7] rounded-3xl p-10 md:p-16 w-[90vw] min-h-[420px] md:min-h-[490px] mx-auto">
					<p className="text-lg md:text-xl text-[#23191A] mb-6">
						We have the largest selection of unique tours. <br />
						Try our easy and quick tour selection for any request. 24-hour support is always happy to answer all your questions.
					</p>
					<button className="bg-[#23191A] text-white text-lg font-semibold rounded-full px-8 py-3 mb-4 transition hover:bg-[#3a2c2d]">
						Get Started
					</button>
					<div className="flex items-center gap-3 mt-2">
						<span className="text-sm text-[#23191A]">The mobile app is available now</span>
